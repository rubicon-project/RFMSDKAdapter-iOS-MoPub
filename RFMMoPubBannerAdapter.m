...
- (void)didReceiveAd:(RFMAdView *)adView{
  if (self.delegate) {
    ...
    [self.delegate bannerCustomEvent:self didLoadAd:self.rfmAdView];
  }
}
...
- (void)willPresentFullScreenModalFromAd:(RFMAdView *)adView{
  ...
  _bannerAdView = adView.superview;
  if (self.delegate) {
